...
#   certificate_arn   = aws_acm_certificate_validation.dawgs_alb_cert_sp_validation01.certificate_arn
...
#   depends_on = [aws_acm_certificate_validation.dawgs_alb_cert_sp_validation01]
# }
