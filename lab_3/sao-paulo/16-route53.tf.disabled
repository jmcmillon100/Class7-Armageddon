...
# Origin subdomain A record -> ALB
resource "aws_route53_record" "dawgs_origin_a" {
  allow_overwrite = true
...
# Origin subdomain AAAA record -> ALB (IPv6)
resource "aws_route53_record" "dawgs_origin_aaaa" {
  allow_overwrite = true
  zone_id         = data.aws_route53_zone.dawgs_public_zone.zone_id
  name            = "origin.${var.domain_name}"
  type            = "AAAA"
