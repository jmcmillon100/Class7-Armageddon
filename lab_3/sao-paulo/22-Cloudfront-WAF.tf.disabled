...
resource "aws_wafv2_web_acl" "dawgs_cf_waf01" {
...
#   # Explanation: AWS managed rules are like hiring Rebel commandawgs — they’ve seen every trick.
#   rule {
#     name     = "AWSManagedRulesCommonRuleSet"
#     priority = 1
...
############################################
# Bonus B - WAF Logging (CloudWatch Logs OR S3 OR Firedawgse)
# One destination per Web ACL, chdawgse via var.waf_log_destination.
############################################
...
# Commented out to avoid errors when using CloudFront WAF, which requires different setup.
