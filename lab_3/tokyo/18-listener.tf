...
resource "aws_lb_listener" "dawgs_https_listener01" {
  ...
  certificate_arn   = aws_acm_certificate_validation.dawgs_alb_cert_tokyo_validation01.certificate_arn
  ...
  depends_on = [aws_acm_certificate_validation.dawgs_alb_cert_tokyo_validation01]
}
